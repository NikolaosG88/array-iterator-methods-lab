...
const inventors = [
  ...
  console.log('___________Exercise 1: Array.prototype.filter()_____________');
...
console.log('___________Exercise 2: Array.prototype.map())_____________');
...
console.log('________Exercise 3___Array.prototype.sort())_____________');
...
console.log('_______Exercise 4____Array.prototype.find()_____________');
...
console.log('______Exercise 5_____Array.prototype.map()_____________');
...
console.log('______Exercise 6_____Array.prototype.some()_____________');
...
console.log('______Exercise 7_____Array.prototype.every()_____________');
...
console.log('______Exercise 8_____Array.prototype.find()_____________');
...
console.log('______Exercise 9_____Array.prototype.findIndex()_____________');
...
console.log('______Exercise 10_____Array.prototype.reduce()_____________');
...
totalYearsLived = inventors.reduce((acc, x) => {
  return  acc +(x.passed - x.year); 
},0);
